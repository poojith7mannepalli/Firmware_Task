...
#define EEPROM_EMULATION_ADDRESS (0x0801F800)
...
uint32_t RxIndex = 0;
uint64_t DoubleWordBuffer = 0; // Buffer to accumulate data for double word programming
uint8_t DoubleWordBufferIndex = 0;
